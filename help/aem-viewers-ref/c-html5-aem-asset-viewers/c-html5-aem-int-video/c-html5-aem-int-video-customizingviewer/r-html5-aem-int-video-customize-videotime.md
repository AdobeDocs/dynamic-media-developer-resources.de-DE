...
Stellen Sie die Zeit des Videos auf Hellgrau (`#BBBBBB`) ein, mit einer Größe von 12 Pixel, 15 Pixel vom oberen Rand der Steuerleiste und 80 Pixel vom oberen und rechten Rand der Steuerleiste.
