...
<table id="table_D4A2035B65B140F882F550B711BD3160"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Wird ausgelöst, wenn die Viewer-Initialisierung abgeschlossen ist und alle internen Komponenten erstellt wurden, sodass die <span class="codeph"> getComponent()- </span> API verwendet werden kann. Der Callback-Handler nimmt keine Argumente an. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Wird ausgelöst, wenn der Benutzer einen Hotspot mit zugehörigen Quick-Ansicht-Daten aktiviert. Der Callback-Handler akzeptiert das folgende Argument: </p> <p> 
     <ul id="ul_171110934BD54839B371FAD8D2AD467B"> 
      <li id="li_7B14C3BA432B43E392AC103926807E88"> <p> <span class="codeph"> data {Object} </span> - ein JSON-Objekt, das Daten aus der Hotspot-Definition enthält. Der <span class="codeph"> Sku für das Feld </span> ist obligatorisch, während andere Felder optional sind und von der Definition des Quell-Hotspots abhängen. </p> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
