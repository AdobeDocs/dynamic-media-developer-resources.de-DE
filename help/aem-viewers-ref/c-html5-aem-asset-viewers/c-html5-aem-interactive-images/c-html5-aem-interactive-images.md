...
## Interaktiven Bild-Viewer einbetten {#section-6bb5d3c502544ad18a58eafe12a13435}
...
1. Hinzufügen der JavaScript-Datei für den Viewer zur Webseite
   ...
   Zum Erstellen eines Viewers müssen Sie im HTML-Kopf ein Skript-Tag hinzufügen. Bevor Sie die Viewer-API verwenden können, stellen Sie sicher, dass Sie [!DNL InterativeImage.js]dies berücksichtigen. Die [!DNL InteractiveImage.js] Datei befindet sich im [!DNL html5/js/] Unterordner Ihrer standardmäßigen IS-Viewer-Bereitstellung:
...
1. Einstellen der Viewer-Größe
   ...
   Sie können die statische Größe des Viewers festlegen, indem Sie ihn entweder für die CSS-Klasse der `.s7interactiveimage` obersten Ebene in absoluten Einheiten deklarieren oder einen `stagesize` Modifikator verwenden.
...
1. Erstellen und Initialisieren des Viewers.
   ...
   Im Folgenden finden Sie ein Beispiel für das Erstellen einer Viewer-Instanz, das die erforderlichen Mindestkonfigurationsoptionen an den Konstruktor übergibt und die `init()` Methode aufruft. Im Beispiel wird davon ausgegangen, dass `interactiveImage` es sich um die Viewer-Instanz handelt. der Name `s7viewer` des Platzhalters `DIV`; ist `http://aodmarketingna.assetsadobe.com/is/image` die Image Serving-URL und `/content/dam/mac/aodmarketingna/shoppable-banner/shoppable-banner.` das Asset:
