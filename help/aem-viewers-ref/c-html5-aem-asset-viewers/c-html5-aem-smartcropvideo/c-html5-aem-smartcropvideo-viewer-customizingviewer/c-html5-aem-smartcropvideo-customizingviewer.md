---
title: Anpassen des Smart Crop Video Viewers
description: Anpassen des Smart Crop Video Viewers
keywords: Responsiv
...
# Anpassen des Smart Crop Video Viewers{#customizing-smartcrop-video-viewer}

Alle visuellen Anpassungen und die meisten Verhaltensanpassungen werden durch Erstellen eines benutzerdefinierten CSS vorgenommen.
...
Beachten Sie beim Erstellen von benutzerdefiniertem CSS, dass der Viewer `.s7smartcropvideoviewer` Klasse seinem Container-DOM-Element zuweist. Wenn Sie eine externe CSS-Datei verwenden, die mit dem `style=`-Befehl übergeben wird, verwenden Sie `.s7smartcropvideoviewer` Klasse als übergeordnete Klasse in der untergeordneten Auswahl für Ihre CSS-Regeln. Wenn Sie Stile auf der Web-Seite einbetten, qualifizieren Sie diesen Selektor auch mit einer ID des Container-DOM-Elements wie folgt:
...
Die Verwendung von CSS-Markern ist die flexibelste Methode zum Erstellen von responsivem entworfenem CSS. Durch diese Flexibilität können Sie nicht nur die Bildschirmgröße des Geräts, sondern auch die tatsächliche Viewer-Größe festlegen, was für Seiten-Layouts mit responsivem Design nützlich sein kann.
...
Im Folgenden finden Sie die Referenzdokumentation zu Benutzeroberflächenelementen, die für den Smart Crop Video Viewer gilt:
