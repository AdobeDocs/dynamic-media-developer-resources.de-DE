...
Legt neue externe Videos und optional zusätzliche Videodaten fest. Kann jederzeit aufgerufen werden, sowohl vor als auch nach `init()`. Wenn nach `init()` aufgerufen, tauscht der Viewer das Video in der Laufzeit aus.
