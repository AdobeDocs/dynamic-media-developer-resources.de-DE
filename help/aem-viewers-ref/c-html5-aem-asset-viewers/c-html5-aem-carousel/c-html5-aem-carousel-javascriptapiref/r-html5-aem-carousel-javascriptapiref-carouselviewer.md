  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="codeph"> {object} </span> optionales JSON-Konfigurationsobjekt ermöglicht es, dass alle Viewer-Einstellungen an den Konstruktor übergeben werden, damit keine einzelnen Setter-Methoden aufgerufen werden. Enthält die folgenden Eigenschaften: </p> <p> 
     <ul id="ul_789DBD5B72ED4C80B685455B0D59494D"> 
      ...
      <li id="li_CD88EDB586B241DBB87B13709F24C454"> <p> <span class="codeph"> lokalisierteTexte </span> - <span class="codeph"> {Objekt} </span> </p> <p> JSON-Objekt mit lokale Anpassungen-Daten. Weitere Informationen zum Inhalt des Objekts finden Sie unter Lokale Anpassung der Elemente der Benutzeroberfläche und im Beispiel. </p> <p>Optional </p> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
