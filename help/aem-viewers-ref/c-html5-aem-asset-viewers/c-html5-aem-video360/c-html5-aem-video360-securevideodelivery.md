...
* Wenn Sie ein Dynamic Media-Video mit Einbettungscode veröffentlichen, fügen Sie `Video360Player.ssl` zur Liste anderer Viewer-Konfigurationsparameter im Einbettungscode-Snippet hinzu. Um beispielsweise die HTTPS-Videobereitstellung zu erzwingen, hängen Sie &quot;`&Video360Player.ssl=on`&quot;wie im folgenden Beispiel an:
