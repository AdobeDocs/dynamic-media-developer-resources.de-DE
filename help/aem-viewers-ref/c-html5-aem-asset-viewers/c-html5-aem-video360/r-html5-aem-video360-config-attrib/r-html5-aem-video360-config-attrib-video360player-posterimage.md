 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Image Serving-Modifikatoren, die das Erscheinungsbild des Standbilds steuern. Wenn in der URL angegeben, können Sie Folgendes HTTP-kodieren: </p> <p> 
     ...
     </ul> </p> <p> Dieser Modifikator funktioniert für Videoinhalte, die auf dynamischen Medien oder dynamischen AEM-Medien gehostet werden. </p> <p>Um die Anzeige des Standbilds zu verhindern, geben Sie <span class="codeph"> none</span> als Standbildwert an. </p> </td> 
  </tr> 
 </tbody> 
</table>
