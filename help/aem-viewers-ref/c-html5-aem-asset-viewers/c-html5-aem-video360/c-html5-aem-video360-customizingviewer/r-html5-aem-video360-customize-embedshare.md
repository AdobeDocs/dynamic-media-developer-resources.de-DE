...
**Beispiel** - zum Einrichten einer Footer mit einer Schaltfläche &quot;Abbrechen&quot;von 64 x 34 mit einer Textfarbe und einer Hintergrundfarbe, die für jeden Schaltflächenstatus unterschiedlich ist:
...
**Beispiel** - Um einen Hauptdialogfeld-Bereich auf eine Höhe von 300 Pixel festzulegen, weisen einen zehnten Pixelrand auf und verwenden einen weißen Hintergrund:
...
**Beispiel** - Zum Festlegen einer Textkopie auf eine Breite von 430 Pixel und mit einem Abstand von zehn Pixeln am unteren Rand:
...
**Beispiel** - Um einen grauen Rahmen von einem Pixel um den Einbettungscode-Text zu setzen, machen Sie ihn mit einer Breite von 430 Pixel und einem Abstand von zehn Pixeln:
...
**Beispiel** - So konfigurieren Sie den Einbettungscode für die Verwendung von `break-word` Wortumbruch:
...
**Beispiel** - zum Festlegen der Höhe des Kombinationsfelds &quot;Einbettungsgröße&quot;auf 40 Pixel:
...
Das Kombinationsfeld verfügt rechts über eine Dropdown-Schaltfläche und wird mit der folgenden CSS-Klassenauswahl gesteuert:
...
**Beispiel** - zum Festlegen des Bereichs für das Kombinationsfeld mit einem grau Rahmen von einem Pixel:
...
**Beispiel** - zum Festlegen eines weißen Hintergrunds für das Kombinationsfeld-Bedienfeld:
...
**Beispiel** - zum Einrichten eines Bildlaufbereichs mit einer Breite von 44 Pixel
...
**Beispiel** : Zum Einrichten einer Bildlaufleiste, die 28 Pixel breit ist und eine 8-Pixel-Spanne von oben, rechts und unten im Bildlaufbereich hat:
...
**Beispiel** - zum Einrichten eines Bildlaufleisten-Miniaturbilds mit 28 x 45 Pixel, einer zehnten Pixelspanne oben und unten und unterschiedlicher Abbildung für jeden Status:
...
**Beispiel** - zum Einrichten von Bildlaufschaltflächen mit einer Größe von 28 x 32 Pixel und unterschiedlicher Abbildung für jeden Status:
