...
Diese Eigenschaft ist erforderlich, es sei denn, es wird `video` ein Parameter verwendet. Siehe [Unterstützung](../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-external-video-support.md#concept-22c67fee43274a29b28ee16770b1b1f3) für externe Videos unter Video oder [Unterstützung](../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-external-video-support.md#concept-66aa2784f2294794989bad2af74c3760) für externe Videos unter Video360.
...
<table id="table_A2A0ACD942E942BC99AF0DC80FB1C670"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Gibt ein explizites mehrdimensionales Rotationsset mit der folgenden Syntax an: </p> <p> <span class="codeph"> (( <span class="varname"> horizontalSpinSet </span>)[,( <span class="varname"> horizontalSpinSet </span>)]) </span> </p> <p> Dabei ist <span class="codeph"> das <span class="varname"> horizontale Rotationsset </span> </span> eine kommagetrennte Liste von Frames für eine bestimmte horizontale Achse. Alle <span class="codeph"> horizontalen <span class="varname"> Rotationssets </span> </span> sollten dieselbe Anzahl von Frames aufweisen. </p> <p> <p>Hinweis:  Diese Funktion wird im Adobe Scene7 Publishing System unterstützt. es wird in Adobe Experience Manager Assets nicht unterstützt. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> Modifikatoren </span></span> </p> </td> 
   <td colname="col2"> <p> Image Serving-Befehle, <span class="codeph"> &amp; </span> - und <span class="codeph"> = </span> -Trennzeichen müssen als <span class="codeph"> %26 </span> bzw. <span class="codeph"> %3D HTTP-kodiert </span>sein. </p> </td> 
  </tr> 
 </tbody> 
</table>
