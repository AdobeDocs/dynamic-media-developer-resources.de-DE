---
description: Scene7 Viewer 5.8.2 - Versionshinweise
...
* Der Wert `native` des Modifikators `playback` ist veraltet. Verwenden Sie stattdessen den neuen Wert `progressive`.
