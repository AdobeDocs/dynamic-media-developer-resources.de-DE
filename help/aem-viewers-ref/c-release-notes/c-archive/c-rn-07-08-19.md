...
* Für Videobeschriftungen ist ein Unternehmensregelsatz erforderlich, wenn die Hosting-HTML-Seite von einem externen Server (nicht von einem [!DNL Dynamic Media]) bereitgestellt wird. Wenden Sie sich an den technischen Support.
