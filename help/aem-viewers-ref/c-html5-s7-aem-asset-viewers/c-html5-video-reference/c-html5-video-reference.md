---
description: Der Video-Viewer ist ein Videoplayer, der Streaming- und progressive Videos wiedergibt, die im H.264-Format kodiert sind. Es wird von Dynamic Media Classic oder Adobe Experience Manager mit Dynamic Media bereitgestellt.
keywords: responsiv
...
Der Video-Viewer ist ein Videoplayer, der Streaming- und progressive Videos wiedergibt, die im H.264-Format kodiert sind. Es wird von Dynamic Media Classic oder Experience Manager mit Dynamic Media bereitgestellt.
...
Wenn ein responsives Design mit definierter Breite und Höhe eingebettet ist, unterscheidet sich der Webseitenstil. Es stellt beide Größen für den &quot;Inhaber&quot; `DIV` bereit und zentriert ihn im Browserfenster. Außerdem setzt die Webseite die Größe des Elements `HTML` und `BODY` auf 100 %:
