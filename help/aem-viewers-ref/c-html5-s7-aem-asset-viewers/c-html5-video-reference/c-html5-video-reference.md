---
title: Video
description: Der Video-Viewer ist ein Video-Player, der im H.264-Format kodierte Streaming- und progressive Videos abspielt. Sie wird von Dynamic Media Classic oder Adobe Experience Manager mit Dynamic Media bereitgestellt.
keywords: Responsiv
...
Der Video-Viewer ist ein Video-Player, der im H.264-Format kodierte Streaming- und progressive Videos abspielt. Sie wird von Dynamic Media Classic oder Experience Manager mit Dynamic Media bereitgestellt.
...
Der Video-Viewer verwendet HTML5-Streaming-Videowiedergabe im HLS-Format in der Standardkonfiguration, wenn das zugrunde liegende System dies unterstützt. Auf Systemen, die HTML5-Streaming nicht unterstützen, wird der Viewer auf die progressive Videobereitstellung von HTML5 zurückgesetzt.
...
1. Hinzufügen der Viewer-JavaScript-Datei zu Ihrer Web-Seite.
   ...
   Um einen Viewer zu erstellen, müssen Sie ein -Skript-Tag in der Kopfzeile von HTML hinzufügen. Bevor Sie die Viewer-API verwenden können, stellen Sie sicher, dass Sie [!DNL FlyoutViewer.js] einbeziehen. Die [!DNL FlyoutViewer.js]-Datei befindet sich im [!DNL html5/js/] Unterordner Ihrer standardmäßigen IS-Viewers-Bereitstellung:
