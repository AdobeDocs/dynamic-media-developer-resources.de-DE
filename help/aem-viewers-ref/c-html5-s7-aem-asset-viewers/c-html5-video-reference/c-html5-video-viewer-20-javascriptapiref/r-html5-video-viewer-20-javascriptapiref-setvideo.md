...
Legt neue externe Videos und optional zusätzliche Videodaten fest. Kann jederzeit vor und nach aufgerufen werden `init()`. Bei einem Aufruf nach `init()`dem Aufruf tauscht der Viewer das Video in der Laufzeit aus.
