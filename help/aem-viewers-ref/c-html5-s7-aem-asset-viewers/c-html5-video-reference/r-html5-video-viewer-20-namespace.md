...
In einigen erweiterten Anwendungsfällen muss die Web-Seite jedoch mithilfe der Viewer-API `getComponent()` auf eine interne SDK-Komponente verweisen und dann die gesamte Flexibilität der APIs des SDK selbst nutzen.
