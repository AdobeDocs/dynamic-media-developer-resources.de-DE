...
seo-title: Anpassen des Video-Viewers
...
Wenn Sie benutzerdefinierte CSS erstellen, denken Sie daran, dass der Viewer seinem Container-DOM-Element `.s7videoviewer` Klasse zuweist. Wenn Sie eine externe CSS-Datei verwenden, die mit dem `style=` Befehl übergeben wird, verwenden Sie `.s7videoviewer` class als übergeordnete Klasse in der untergeordneten Auswahl für Ihre CSS-Regeln. Wenn Sie Stile auf der Webseite einbetten, sollten Sie diesen Selektor zusätzlich mit einer ID des Container-DOM-Elements wie folgt qualifizieren:

`#<containerId>.s7videoviewer`

## Responsive CSS erstellen {#section-63e8f93ee2f14fd8bba1ce33a6870b80}
...
## Allgemeine Hinweise und Hinweise zur Formatierung {#section-097418bd618740bba36352629e4d88e1}
