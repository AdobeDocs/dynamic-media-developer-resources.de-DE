...
Im obigen Codebeispiel wird die Lautstärke auf `0` der `mutableVolume` Komponente eingestellt. Dann wird dieselbe Komponente deaktiviert, sodass sie vom Endbenutzer nicht verwendet werden kann.
