---
title: Anpassen des Inline-Zoom-Viewers
description: Anpassen des Inline-Zoom-Viewers
keywords: Responsiv
...
# Anpassen des Inline-Zoom-Viewers{#customizing-inline-zoom-viewer}
...
Außerdem ist es wichtig, die folgende CSS-Deklaration aus dem Standard-Viewer-CSS beizubehalten, da sie für die Inline-Zoom-Funktion erforderlich ist:
...
Die Verwendung von CSS-Markern ist die flexibelste Methode zum Erstellen von responsivem entworfenem CSS. Dadurch kann nicht nur die Bildschirmgröße des Geräts, sondern auch die tatsächliche Viewer-Größe ausgewählt werden, was für responsive Web-Seiten-Layouts nützlich sein kann.
...
Bei einem klassischen Stilansatz hätte das CSS für jeden Status des Benutzeroberflächenelements einen separaten Verweis auf eine einzelne Bilddatei auf dem Server. Im Folgenden finden Sie ein Beispiel für die CSS-Formatierung einer Scroll-Schaltfläche:
