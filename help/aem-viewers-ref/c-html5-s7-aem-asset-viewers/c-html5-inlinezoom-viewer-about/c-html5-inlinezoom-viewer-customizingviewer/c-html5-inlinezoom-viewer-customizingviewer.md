...
Darüber hinaus ist es wichtig, die folgende CSS-Deklaration aus der Standard-Viewer-CSS beizubehalten, da sie für die Inline-Zoom-Funktion erforderlich ist:
...
Bei einem klassischen Stilverfahren würde das CSS für jeden Status des Elements der Benutzeroberfläche einen separaten Verweis auf die einzelne Bilddatei auf dem Server haben. Im Folgenden finden Sie ein Beispiel-CSS zum Formatieren einer Bildlaufschaltfläche:
