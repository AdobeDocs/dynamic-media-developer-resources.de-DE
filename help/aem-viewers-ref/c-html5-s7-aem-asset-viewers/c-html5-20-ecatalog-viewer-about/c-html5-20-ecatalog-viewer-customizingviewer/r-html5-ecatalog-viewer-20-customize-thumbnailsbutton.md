---
title: Schaltfläche „Miniaturen“
description: Durch Klicken oder Tippen auf diese Schaltfläche wird der Viewer zwischen der Hauptansicht und den Miniaturen zurückgesetzt. Diese Schaltfläche wird in der Hauptsteuerleiste angezeigt. Sie können diese Schaltfläche mithilfe von CSS skalieren, anpassen und positionieren.
...
Wenn Sie diese Schaltfläche auswählen oder tippen, wird der Viewer zwischen der Hauptansicht und den Miniaturen zurückgesetzt. Diese Schaltfläche wird in der Hauptsteuerleiste angezeigt. Sie können diese Schaltfläche mithilfe von CSS skalieren, anpassen und positionieren.
