---
description: Alle visuellen Anpassungen und die meisten Verhaltensanpassungen für den E-Katalog-Viewer erfolgen durch Erstellung einer benutzerdefinierten CSS.
keywords: responsive
seo-description: Alle visuellen Anpassungen und die meisten Verhaltensanpassungen für den E-Katalog-Viewer erfolgen durch Erstellung einer benutzerdefinierten CSS.
...
Alle visuellen Anpassungen und die meisten Verhaltensanpassungen für den E-Katalog-Viewer erfolgen durch Erstellung einer benutzerdefinierten CSS.
...
Beachten Sie beim Erstellen von benutzerdefiniertem CSS, dass der Viewer seinem Container-DOM-Element `.s7ecatalogviewer` Klasse zuweist. Wenn Sie eine externe CSS-Datei verwenden, die mit dem `style=` Befehl übergeben wird, verwenden Sie `.s7ecatalogviewer` class als übergeordnete Klasse in der untergeordneten Auswahl für Ihre CSS-Regeln. Wenn Sie eingebettete Stile auf der Webseite verwenden, sollten Sie diesen Selektor zusätzlich mit einer ID des Container-DOM-Elements wie folgt qualifizieren:
...
Nachstehend finden Sie eine Referenzdokumentation zu Elementen der Benutzeroberfläche, die für den E-Katalog-Viewer gilt:
