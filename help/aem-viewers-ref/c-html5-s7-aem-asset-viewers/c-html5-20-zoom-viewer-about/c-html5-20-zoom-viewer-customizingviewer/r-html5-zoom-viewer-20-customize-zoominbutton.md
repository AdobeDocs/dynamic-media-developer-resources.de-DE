...
Durch Auswählen oder Tippen auf diese Schaltfläche wird ein Bild in der Hauptansicht vergrößert. Diese Schaltfläche wird nicht auf Mobiltelefonen angezeigt, um Platz auf dem Bildschirm zu sparen. Sie können diese Schaltfläche mithilfe von CSS skalieren, anpassen und positionieren.
