...
Legt ein neues Asset fest. Sie können diesen Parameter jederzeit aufrufen, entweder vor oder nach [!DNL `init()`]. Wenn es nach [!DNL `init()`]dem Aufruf aufgerufen wird, tauscht der Viewer das Asset zur Laufzeit aus.
