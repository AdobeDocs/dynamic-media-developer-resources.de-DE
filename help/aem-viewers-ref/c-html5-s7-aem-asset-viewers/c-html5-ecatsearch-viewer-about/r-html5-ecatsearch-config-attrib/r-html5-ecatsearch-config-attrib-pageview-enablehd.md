...
[!DNL `[PageView.|<containerId>_pageView.]enableHD=always|never|limit[, *`Zahl`*]`]
...
<table id="table_F97FEDA0EE1B4EF6AC9FF9060548ACA4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Die Pixeldichte des Bildschirms/Geräts wird dabei immer berücksichtigt. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Eine Gerätepixeldichte wird nur angefordert und bereitgestellt, wenn das resultierende Bild unter dem angegebenen Grenzwert liegt. </p> <p>Die Zahl für die Begrenzung gilt entweder für die Breite oder die Höhe. </p> <p> 
     ...
     </ul> </p> <p><b>Best Practice</b>: Die Limit-Anzahl muss mit der Unternehmenseinstellung für die maximale Bildgröße zusammenarbeiten. Legen Sie daher die Limit-Nummer auf die Einstellung für die maximale Bildgröße des Unternehmens fest. </p> </td> 
  </tr> 
 </tbody> 
</table>
