...
description: Wenn Sie diese Schaltfläche auswählen, gelangen Sie zur letzten Seite des Katalogs. Diese Schaltfläche wird in der Hauptsteuerleiste auf Desktop-Systemen und Tablets angezeigt. Bei Mobiltelefonen wird sie zu einer sekundären Steuerleiste hinzugefügt. Sie können diese Schaltfläche mithilfe von CSS skalieren, anpassen und positionieren.
...
Wenn Sie diese Schaltfläche auswählen, gelangen Sie zur letzten Seite des Katalogs. Diese Schaltfläche wird in der Hauptsteuerleiste auf Desktop-Systemen und Tablets angezeigt. Bei Mobiltelefonen wird sie zu einer sekundären Steuerleiste hinzugefügt. Sie können diese Schaltfläche mithilfe von CSS skalieren, anpassen und positionieren.
...
Beispiel: So richten Sie eine Schaltfläche für die letzte Seite ein, die 28 x 28 Pixel groß ist und 4 Pixel vom unteren Rand und 220 Pixel vom linken Rand der Hauptsteuerleiste entfernt positioniert ist. Schließlich zeigt für jeden der vier verschiedenen Schaltflächenzustände ein eigenes Bild an.
