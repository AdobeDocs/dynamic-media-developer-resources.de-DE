...
description: Wenn Sie diese Schaltfläche auswählen, wird der Benutzer zur letzten Seite des Katalogs geleitet. Diese Schaltfläche wird in der Hauptsteuerleiste auf Desktop-Systemen und Tablets angezeigt. auf Mobiltelefonen wird sie zu einer sekundären Kontrollleiste hinzugefügt. Mithilfe von CSS können Sie diese Schaltfläche vergrößern, verkleinern und positionieren.
...
Wenn Sie diese Schaltfläche auswählen, wird der Benutzer zur letzten Seite des Katalogs geleitet. Diese Schaltfläche wird in der Hauptsteuerleiste auf Desktop-Systemen und Tablets angezeigt. auf Mobiltelefonen wird sie zu einer sekundären Kontrollleiste hinzugefügt. Mithilfe von CSS können Sie diese Schaltfläche vergrößern, verkleinern und positionieren.
...
Beispiel: Zum Einrichten einer Schaltfläche für die letzte Seite, die 28 x 28 Pixel groß ist und 4 Pixel vom unteren Rand und 220 Pixel vom linken Rand der Hauptsteuerungsleiste positioniert hat. Und schließlich zeigt ein anderes Bild für jeden der vier verschiedenen Schaltflächenstatus an.
