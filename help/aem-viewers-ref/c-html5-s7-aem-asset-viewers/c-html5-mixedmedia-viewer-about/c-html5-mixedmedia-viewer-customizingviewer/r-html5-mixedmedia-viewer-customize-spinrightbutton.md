...
Wenn Sie diese Schaltfläche auswählen, wird das Bild in der Hauptansicht rechts gedreht. Diese Schaltfläche wird nicht auf Mobiltelefonen angezeigt, um die Grundstücksgröße auf dem Bildschirm zu sparen. Außerdem ist die Schaltfläche ausgeblendet, wenn ein mehrdimensionales Rotationsset verwendet wird. Sie können die Schaltfläche mithilfe von CSS vergrößern, verkleinern und positionieren.
...
Beispiel: Zum Einrichten einer Schaltfläche mit der rechten Maustaste, die 28 x 28 Pixel groß ist und sich auf der rechten Kante des inneren Containers befindet. Schließlich zeigt für jeden der vier Schaltflächenstatus ein anderes Bild an:
