...
Wenn Sie beispielsweise planen, das `StatusEvent.NOTF_VIEW_READY` Ereignis anzuhören und der Viewer von AEM bereitgestellt wird, ist der voll qualifizierte Ereignistyp `s7viewers.s7sdk.event.StatusEvent.NOTF_VIEW_READY`und der Ereignis-Listener-Code sieht ähnlich wie folgt aus:
