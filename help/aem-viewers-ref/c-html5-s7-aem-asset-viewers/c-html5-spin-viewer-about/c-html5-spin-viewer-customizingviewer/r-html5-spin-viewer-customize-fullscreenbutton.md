...
description: Diese Schaltfläche bewirkt, dass der Viewer in den Vollbildmodus wechselt oder diesen verlässt, wenn er vom Benutzer ausgewählt wird. Diese Schaltfläche wird nicht angezeigt, wenn der Viewer im Popup-Modus funktioniert und das System keinen nativen Vollbildmodus unterstützt. Sie können diese Schaltfläche mithilfe von CSS skalieren, anpassen und positionieren.
