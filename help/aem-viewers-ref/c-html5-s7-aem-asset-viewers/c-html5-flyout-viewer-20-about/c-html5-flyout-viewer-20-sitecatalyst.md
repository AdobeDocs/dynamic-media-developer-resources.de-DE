...
Der Flyout-Viewer unterstützt die [!DNL Adobe Analytics] sofortige Verfolgung. Um die Verfolgung zu aktivieren, übergeben Sie den richtigen Vorgabennamen für die Firma als `config2` Parameter.
