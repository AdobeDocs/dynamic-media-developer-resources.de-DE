...
user-guide-description: Die IPS (Image Production System)-Webservice-API ermöglicht es externen Anwendungen und Drittanbieterentwicklern, programmgesteuert auf IPS-Assets und -Funktionen zuzugreifen.
...
+ Operationsmethoden {#operation-methods}
   ...
   + Betriebsparameter {#operation-parameters}
      ...
      + [addGroupMitgliedschaft](operations/c-operations-intro/c-methods/r-add-group-membership.md)
      ...
      + [getCompanyMitgliedschaft](operations/c-operations-intro/c-methods/r-get-company-membership.md)
      ...
      + [getGroupMitgliedschaft](operations/c-operations-intro/c-methods/r-get-group-membership.md)
      ...
      + [getFotoshopPath](operations/c-operations-intro/c-methods/r-get-photoshop-path.md)
      + [getFotoshopPathNames](operations/c-operations-intro/c-methods/r-get-photoshop-path-names.md)
      ...
      + [Auftrag anhalten](operations/c-operations-intro/c-methods/r-pause-job.md)
      ...
      + [removeGroupMitgliedschaft](operations/c-operations-intro/c-methods/r-remove-group-membership.md)
      + [removeProjectAssets](operations/c-operations-intro/c-methods/r-remove-project-assets.md)
      + [Asset umbenennen](operations/c-operations-intro/c-methods/r-rename-asset.md)
      + [Ordner umbenennen](operations/c-operations-intro/c-methods/r-rename-folder.md)
      + [Projekt umbenennen](operations/c-operations-intro/c-methods/r-rename-project.md)
      ...
      + [setGroupMitgliedschaft](operations/c-operations-intro/c-methods/r-set-group-membership.md)
...
+ Datentypen {#data-types}
   + [Datentypen](types/c-data-types/c-data-types.md)
   + [AcoInfo](types/c-data-types/r-aco-info.md)
   + [Aktiver Vorgang](types/c-data-types/r-active-job.md)
   ...
   + [Asset-Array](types/c-data-types/r-asset-array.md)
   ...
   + [Asset verschieben](types/c-data-types/r-asset-move.md)
   ...
   + [Asset-Zusammenfassung](types/c-data-types/r-asset-summary.md)
   ...
   + [Firma](types/c-data-types/r-company.md)
   + [FirmaArray](types/c-data-types/r-company-array.md)
   + [Firmenmitglied](types/c-data-types/r-company-member.md)
   + [CompanyMemberArray](types/c-data-types/r-company-member-array.md)
   + [Firmenmitgliedschaft](types/c-data-types/r-company-membership.md)
   ...
   + [Unternehmenseinstellungen](types/c-data-types/r-company-settings.md)
   ...
   + [Festplattenauslastung](types/c-data-types/r-disk-usage.md)
   ...
   + [Exportvorgang](types/c-data-types/r-exportjob.md)
   + [FlashInfo](types/c-data-types/r-flash-info.md)
   + [Ordner](types/c-data-types/r-folder.md)
   + [Ordner-Array](types/c-data-types/r-folder-array.md)
   ...
   + [generateAttribute](types/c-data-types/r-generation-attribute.md)
   ...
   + [GruppeArray](types/c-data-types/r-group-array.md)
   ...
   + [JavaScript-Info](types/c-data-types/r-javascriptinfo.md)
   ...
   + [Schlüsselwörter](types/c-data-types/r-keywords.md)
   + [SchlüsselwörterArray](types/c-data-types/r-keywords-array.md)
   ...
   + [Betriebsstörung](types/c-data-types/r-operation-fault.md)
   ...
   + [Fotoshop-Optionen](types/c-data-types/r-photoshop-options.md)
   ...
   + [Projekt-Array](types/c-data-types/r-project-array.md)
   + [Eigenschaft](types/c-data-types/r-property.md)
   ...
   + [Veröffentlichungsverlauf](types/c-data-types/r-publish-history.md)
   ...
   + [SystemfeldBedingung](types/c-data-types/r-system-field-condition.md)
   ...
   + [Aufgabenfortschritt](types/c-data-types/r-task-progress.md)
   ...
   + [Optionen für Miniaturansichten](types/c-data-types/r-thumbnail-options.md)
   + [UncompressOptions](types/c-data-types/r-uncompress-options.md)
   + [UnschärfemaskenOptionen](types/c-data-types/r-unsharp-mask-options.md)
   ...
   + [URL-Array](types/c-data-types/r-url-array.md)
   + [Benutzer](types/c-data-types/r-user.md)
   + [Benutzer-Array](types/c-data-types/r-user-array.md)
   ...
   + [Wasserzeichen-Info](types/c-data-types/r-watermark-info.md)
...
+ Zeichenfolgenkonstanten {#sting-constants}
   ...
   + [Status aktiver Aufträge](string-constants/c-string-constants/r-active-job-states.md)
   + [Systemfelder für die Asset-Suche](string-constants/c-string-constants/r-asset-search-system-fields.md)
   + [Asset-Überschreibungsmodi](string-constants/c-string-constants/r-asset-overwrite-modes.md)
   + [Asset-Sortierfelder](string-constants/c-string-constants/r-asset-sort-fields.md)
   + [Asset-Typen](string-constants/c-string-constants/r-asset-types.md)
   + [Ecke für automatisches Zuschneiden](string-constants/c-string-constants/r-auto-crop-corner.md)
   + [Farbmanagementmodi](string-constants/c-string-constants/r-color-management-modes.md)
   ...
   + [Erzeugungsinformationen](string-constants/c-string-constants/r-generation-info.md)
   + [Illustrator-Prozesse](string-constants/c-string-constants/r-illustrator-processes.md)
   + [Job Log-Dateitypen](string-constants/c-string-constants/r-job-log-file-types.md)
   + [Vorgangslog-Sortierfelder](string-constants/c-string-constants/r-job-log-sort-fields.md)
   + [Vorgangslog-Typen](string-constants/c-string-constants/r-job-log-types.md)
   + [Status von Job Trigger](string-constants/c-string-constants/r-job-trigger-states.md)
   + [Vorgangstypen](string-constants/c-string-constants/r-job-types.md)
   + [Metadatenfeldtypen](string-constants/c-string-constants/r-metadata-field-types.md)
   + [Numerische/Datumsvergleichsoperatoren](string-constants/c-string-constants/r-numeric-date-comparison-operators.md)
   ...
   + [Papierkorb-Zustand](string-constants/c-string-constants/r-trash-state.md)
   + [User Char Filter-Felder](string-constants/c-string-constants/r-user-char-filter-fields.md)
   + [Benutzerrollen](string-constants/c-string-constants/r-user-roles.md)
   + [Benutzerdefinierte Sortierfelder](string-constants/c-string-constants/r-user-sort-fields.md)
   + [Viewer-Typ](string-constants/c-string-constants/r-viewer-type.md)
+ Fehler {#faults}
   + [Fehlerübersicht](faults/c-faults/c-faults.md)
...
+ [Assets werden über HTTP-POSTs in die UploadFile hochgeladen …](c-http-post.md)
