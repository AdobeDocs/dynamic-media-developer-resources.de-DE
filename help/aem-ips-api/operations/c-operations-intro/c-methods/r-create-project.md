...
Dieses Codebeispiel erstellt ein Projekt, das in einer vom Handle angegebenen Firma aufgerufen wird `ApiTestProject` . Die Antwort gibt den Handle an das Projekt zurück.
