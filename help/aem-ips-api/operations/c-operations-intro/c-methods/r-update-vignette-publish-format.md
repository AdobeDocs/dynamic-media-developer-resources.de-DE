...
| ` *`targetWidth`*` | `xsd:int` | Ja | Gibt die Zielgruppe der resultierenden Vignettenbreite in Pixel an. Verwenden Sie null, damit die Ausgabevignette dieselbe Größe wie die Mastervignette hat. |
| ` *`targetHeight`*` | `xsd:int` | Ja | Gibt die Zielgruppe der resultierenden Vignettenhöhe in Pixel an. Verwenden Sie null, damit die Ausgabevignette dieselbe Größe wie die Mastervignette hat. |
