...
Vignettenformate geben die Größe veröffentlichter Vignetten und deren Miniaturansichten sowie Zoomstufen, Scharfzeichnungsparameter und die Dateiformatversion für Vignetten an, die aus Mastervignetten erstellt wurden, die auf einem Image Rendering-Server vom IPS veröffentlicht wurden.
...
<table id="table_4D5B2913FA784EC09190F25223C1A680"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> Codebegriff </span> </td> 
   <td colname="col3"> Ja </td> 
   <td colname="col4"> <p>Gibt die Zielgruppe der resultierenden Vignettenbreite in Pixel an. </p> <p>Verwenden Sie null, damit die Ausgabevignette dieselbe Größe wie die Mastervignette hat. </p> </td> 
  </tr> 
  <tr> 
