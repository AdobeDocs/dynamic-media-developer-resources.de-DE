...
<table id="table_57CEE262A33A4E898C6AFB30C93FD874"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3">Eine Liste von Asset-Typen, die bei einer Suche zurückgegeben werden sollen. Beispiel: <span class="codeph"> Bild</span>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> type:StringArray</span> </td> 
   <td colname="col3">Eine Liste von Asset-Untertypen, die bei einer Suche zurückgegeben werden sollen. Bei einem <span class="codeph"> AssetSet</span>können Sie beispielsweise nach dem <span class="codeph"> MediaType</span> -Untertyp suchen. </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="codeph"><span class="varname"> striktSubTypeCheck</span></span> </td> 
   <td colname="col2"><span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>Ein optionales boolesches Flag, das angibt, ob Assets ohne Untertyp zurückgegeben werden sollen, wenn <span class="codeph"> assetSubTypeArray</span> weitergegeben wird. </p> <p>Wenn "true", werden nur Assets mit einem der angegebenen Untertypen zurückgegeben. </p> <p>Wenn "false", werden auch Assets ohne Subtyp zurückgegeben. </p> <p>Die Standardeinstellung ist "false". </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">Angeben: 
    <ul id="ul_96FFEE28F7624C1FB0356776B4C7CD53"> 
     ...
     <li id="li_9A9A852248DB490DB958AE986DF02672"><span class="codeph"> NotMarkedForPublish</span> , um nicht veröffentlichte Assets zurückzugeben. </li> 
  ...
  <tr> 
   ...
   <td colname="col3">Angeben: 
    <ul id="ul_D31B903FA8DA4CFFABAFABA3D8DA91EC"> 
     <li id="li_E4386C8260E64F0BAFE5BA57FF788E48"><span class="codeph"> Alle</span> , die Assets unabhängig vom Papierkorbsstatus zurückgeben. </li> 
     <li id="li_0B8933FE18C643828075EC8CE8C0223C"><span class="codeph"> NichtInPapierkorb</span> , um "normale"Assets zurückzugeben. </li> 
