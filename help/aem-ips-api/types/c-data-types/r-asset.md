...
<table id="table_C58EF9963CB34179A9D6C9F0F6FF24F2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:AnimatedGifInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:CabinetInfo</span> </td> 
   <td colname="col3"> Eigenschaften für einen abgelegten Asset-Typ. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:CssInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> Verarbeiten Sie den übergeordneten Ordner des Assets. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> [!DNL fontInfo]</span> </span> </td> 
   <td colname="col2"> <span class="codeph">:fontInfo</span> </td> 
   <td colname="col3"> Eigenschaften für ein Schriftarten-Asset. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> [!DNL iccProfileInfo]</span> </span> </td> 
   <td colname="col2"> <span class="codeph">:IccProfileInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:ImageInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:JavaScriptInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:dateTime</span> </td> 
   <td colname="col3"> Letztes Änderungsdatum des Assets </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:LayerViewInfo</span> </td> 
   <td colname="col3"> Eigenschaften für ein Asset in der Ebenenansicht. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:MetadataArray</span> </td> 
   <td colname="col3"> Array von mit dem Asset verknüpften Metadatenwerten. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:RenderSceneInfo</span> </td> 
   <td colname="col3"> Eigenschaften eines Render-Szenen-Assets. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">Generischer Asset-Untertyp, der Untertypwerte unterstützt (z. B. <span class="codeph"> AssetSet</span>). </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> [!DNL svgInfo]</span> </span> </td> 
   <td colname="col2"> <span class="codeph">:SvgInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:SwcInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:TemplateInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> Zeigt an, ob sich ein Asset im Papierkorb befindet oder live ist (Werte finden Sie unter „Papierkorb-Status„). </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> [!DNL type]</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">Asset-Typ Werte finden Sie unter <a href="../../string-constants/c-string-constants/r-asset-types.md#reference-2fe75d230663419d88632d30f1144a10" format="dita" scope="local"> Asset</a>Typen . </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> [!DNL videoCaptionInfo]</span> </span> </td> 
   <td colname="col2"> <span class="codeph">:VideoCaptionInfo</span> </td> 
   <td colname="col3"> <p>Eigenschaften eines Video-Untertitel-Assets. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:ViewerPresetInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:ViewerSwfInfo</span> </td> 
   <td colname="col3"> Eigenschaften eines SWf-Assets im Viewer. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> [!DNL vignetteInfo]</span> </span> </td> 
   <td colname="col2"> <span class="codeph">:VignetteInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:WatermarkInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:WindowCoveringInfo</span> </td> 
   <td colname="col3"> Eigenschaften eines Fensters, das ein Asset abdeckt. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:XmlInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph">:XslInfo</span> </td> 
