...
+ Image-Serving-API-{#image-serving-api}
   ...
   + Konfigurations- und {#config-admin}
      ...
      + {#server-monitoring} zur Serverüberwachung
   ...
   + HTTP-Protokollreferenz {#http-protocol-reference}
      ...
      + {#text-formatting} zur Textformatierung
      ...
      + {#command-reference}
         ...
         + [Ergebnis](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-effect.md)
         ...
         + [op_sum](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-op-usm.md)
      ...
      + {#response-data} der Antwortdaten
   ...
   + FXG-Serverprotokoll-{#fxg-server-protocol-ref}
      ...
      + FXG-Serverprotokoll-{#fxg-server-protocol}
         ...
         + FXG-Serverprotokoll-{#protocol-ref}
            ...
            + [Skala](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/r-is-fxg-scale.md)
         ...
         + {#batch-process-commands} für Stapelverarbeitungsbefehle
   ...
   + {#image-catalog-reference} zum Bildkatalog
      ...
      + Katalogattribute {#catalog-attributes}
         ...
         + [Standardattribute für Anfragen](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-catalog-attributes/r-default-request-attributes.md)
   ...
   + Referenz für Bild-/SVG-{#image-svg-ref}
      ...
      + {#image-data-reference} für Bilddaten
   ...
   + {#macro-definition} der Makrodefinition
   ...
   + {#rule-set-reference} des Regelsatzes
...
+ API-{#image-rendering-api} zum Rendern von Bildern
   ...
   + Server-{#server-administration}
      ...
      + {#configuration-settings-reference} zu Konfigurationseinstellungen
   ...
   + HTTP-Protokollreferenz {#http-protocol-reference}
      ...
      + HTTP-Protokollsyntax und -Funktionen {#http-protocol-syntax}
         ...
         + Verschachtelungs- und Einbettungs-{#request-nesting-and-embedding} anfordern
   ...
   + Materialkatalog {#material-catalog}
      ...
      + {#material-catalog-overview} des Materialkatalogs
      ...
      + Attribute-{#attributes-reference}
         ...
         + [Makrodatei](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-macrofile.md)
         ...
         + [Stammpfad *](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-rootpath.md)
         ...
         + [TIFF-Kodierung](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-tiffencoding.md)
         + [Zeitstempel](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-timestamp.md)
      ...
      + {#material-data-reference} der Materialdaten
         ...
         + [Grundfarbe](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-basecolor.md)
         ...
         + [Raueit](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-roughness.md)
      ...
      + {#macro-definition-reference} für die Makrodefinition
