...
**`Action`= „set“ |`"add"`**: Optional. Die Standardeinstellung ist `"set"`, wodurch alle aktuellen Header-Werte ersetzt werden. Geben Sie `"add"` an, damit Sie den Kopfzeilenwert, getrennt durch ein Komma, anhängen können.
