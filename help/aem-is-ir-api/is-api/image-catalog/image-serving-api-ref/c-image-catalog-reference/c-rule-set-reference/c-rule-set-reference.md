...
Eine Kopie von [!DNL RuleSet.xsd] wird im Katalogordner bereitgestellt und sollte zur Überprüfung einer Regelsatzdatei verwendet werden, bevor sie in der [!DNL catalog.ini] Datei registriert wird. Beachten Sie, dass Image Serving eine interne Kopie von [!DNL RuleSet.xsd] zur Überprüfung verwendet.
...
[ [!DNL package java.util.regex] ](https://www2.cs.duke.edu/csed/java/jdk1.4.2/docs/api/) beschreibt die spezielle Implementierung des regulären Ausdrucks, die Image Serving verwendet.
