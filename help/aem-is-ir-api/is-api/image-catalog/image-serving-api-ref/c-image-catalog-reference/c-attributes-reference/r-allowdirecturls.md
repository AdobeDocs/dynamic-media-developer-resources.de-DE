...
Aktiviert oder deaktiviert die Unterstützung für eingebettete absolute URLs in `src=`- und `mask=`-Befehlen. Wenn diese Option deaktiviert ist, sind nur URLs erlaubt, die relativ zu `attribute::RootUrl` sind.
