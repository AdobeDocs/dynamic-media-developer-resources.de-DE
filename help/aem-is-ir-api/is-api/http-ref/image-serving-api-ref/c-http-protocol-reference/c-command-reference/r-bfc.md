...
<table id="simpletable_2D23B1B282CD4216AB5BE7E7430D1B3F"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Gibt an, ob die Konvertierungsfunktion des Browsers für Formatformate beim Konvertieren von JPEG- oder PNG-Bildern in kleinere browserspezifische Dateiformate wahr ( <span class="codeph"> bei </span>) oder falsch ( <span class="codeph"> von </span> bei keiner browserspezifischen Formatkonvertierung) ist. </p> </td> 
 </tr> 
</table>
