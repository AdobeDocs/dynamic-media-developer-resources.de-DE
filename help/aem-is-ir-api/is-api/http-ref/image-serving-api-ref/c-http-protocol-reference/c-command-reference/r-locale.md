...
Mit dieser ID und den mit `attribute::LocaleMap` und festgelegten Regeln wendet Image Serving `attribute::LocaleStrMap`eine optionale Katalog-ID-Übersetzung und Zeichenfolgen-lokale Anpassung an.

## Eigenschaften {#section-1854a9902b884d9b8e8e713b6635723f}

Anforderungsbefehl. Gilt für die gesamte Anforderung, einschließlich verschachtelter/eingebetteter Anforderungen, unabhängig davon, wo sie angegeben wurde. `locId` darf nur druckbare ASCII-Zeichen enthalten. Wird ignoriert, wenn keine lokale Anpassung-Maps im Hauptkatalog dieser Anforderung definiert sind. Wenn leer oder ungültig angegeben `locId` ist und keine Standardregel in definiert ist, wird ein Fehler zurückgegeben `attribute::DefaultLocale`.
