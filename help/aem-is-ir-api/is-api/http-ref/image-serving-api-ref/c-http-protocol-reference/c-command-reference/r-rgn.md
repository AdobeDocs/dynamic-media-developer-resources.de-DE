...
>[!NOTE]
>
>`rgn=` definiert nur einen ROI, ohne das Bild zu beschneiden. Wenn `wid=` und/oder größer als `hei=` die Größe angewendet werden, können zusätzliche Daten aus dem zusammengesetzten Bild im endgültigen Antwortbild sichtbar sein.
