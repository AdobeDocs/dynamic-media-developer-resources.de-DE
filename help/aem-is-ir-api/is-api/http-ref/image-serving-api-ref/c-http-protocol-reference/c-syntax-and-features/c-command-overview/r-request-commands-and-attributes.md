...
<table id="simpletable_3F7C17FB9E374EFDAD01EB24F57EC367"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Überschreibt das standardmäßige Verhalten beim Zwischenspeichern von Antworten. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Gibt an, welches Bild anstelle einer fehlenden Bilddatei verwendet werden soll. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Legt das Ausgabefarbprofil fest. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Bettet das Farbprofil in das Antwortbild ein. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Bettet Photoshop-Pfaddaten in das Antwortbild ein. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Gibt den im Antwortbild eingebetteten Wert für die Druckauflösung an. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Wählt den Anfragetyp aus. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Gibt den Modus für das Neuabtasten oder die Interpolation von Bildern an. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Gibt eine Zusammensetzungsvorlage an. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-locale.md#reference-8a846b2fbc004a12821b956ed3b25cfb" type="reference" format="dita" scope="local"> Gebietsschema</a> </p></td> 
  <td class="stentry"> <p>Gibt eine Zusammensetzungsvorlage an. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Bild-/Metadatenversions-ID. </p></td> 
 </tr> 
 <tr class="strow"> 
