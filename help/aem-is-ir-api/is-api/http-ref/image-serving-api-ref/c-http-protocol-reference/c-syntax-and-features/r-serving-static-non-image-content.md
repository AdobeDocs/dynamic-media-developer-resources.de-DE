...
Image Serving bietet einen Mechanismus zum Verwalten von Nicht-Bild-Inhalten in Katalogen und deren Bereitstellung über einen separaten `context /is/content`. Der Mechanismus ermöglicht die separate Konfiguration der TTL für jedes Element.
...
<table id="table_3B111EC3AA1044FB9B659FD54BADDC39"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> Optionaler Datentyp; kann zum Filtern von Anforderungen für statischen Inhalt mit dem Befehl type= verwendet werden </p> </td> 
  </tr> 
 </tbody> 
</table>
