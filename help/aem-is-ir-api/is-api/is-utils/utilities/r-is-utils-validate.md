---
description: Bildvalidierungsprogramm. Dieses Befehlszeilen-Dienstprogramm überprüft Bilddateien, um sicherzustellen, dass sie gültig sind und problemlos von Image Serving gelesen werden können.
...
<table id="simpletable_D2C6B20E1007433AB4184A73046A44F0"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p> <span class="codeph"> -jpeg | -ptif | -any  </span> </p> <p>Quelldateityp; muss mindestens eine angegeben werden (-any erlaubt dieselben Bilddateitypen, die von IC unterstützt werden). </p> </td> 
 </tr> 
 <tr class="strow"> 
