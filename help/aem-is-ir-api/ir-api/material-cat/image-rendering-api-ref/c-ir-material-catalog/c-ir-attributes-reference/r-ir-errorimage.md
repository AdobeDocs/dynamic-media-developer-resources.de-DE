...
Erbt von, `default::ErrorImage` wenn es nicht definiert ist. Wenn es definiert, aber leer ist, ist das Verhalten des Fehlerbilds deaktiviert, auch wenn es definiert `default::ErrorImage` ist, und es wird ein HTTP-Fehlerstatus zurückgegeben.
