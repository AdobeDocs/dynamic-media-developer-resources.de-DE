...
Textzeichenfolge. Wenn angegeben, muss ein gültiger `icc::Name` Wert aus der ICC-Profil-Map entweder dieses Materialkatalogs oder des Standardkatalogs oder ein Dateipfad relativ zu `attribute::RootPath`sein. Das referenzierte ICC-Profil muss ein RGB-Profil sein.
