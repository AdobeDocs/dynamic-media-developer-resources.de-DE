...
Der Befehl bzw. das Material bzw. beides wird nach diesem Auswahlbefehl und vor dem nächsten Auswahlbefehl (oder dem Ende der Anforderung) auf das ausgewählte Element angewendet. Mithilfe von Auswahlbefehlen werden Segmente für Materialspezifikationen (MSS) voneinander getrennt.
...
<table id="simpletable_028957E516644FE8A7B1BC056A32FCD1"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Wählen Sie eine Vignettengruppe oder ein Objekt anhand des Namens aus. </p></td> 
 </tr> 
 <tr class="strow"> 
