...
Die Materialien zum Abdecken von Fenstern geben eine *Fensterbedeckungsstil-Datei* ( [!DNL .vnw] Dateierweiterung) an, eine spezielle Datendatei ähnlich einer Vignette, die Maske-, Beleuchtungs-, Layout- und Texturdaten zur Definition der Fensterbedeckung enthält.
