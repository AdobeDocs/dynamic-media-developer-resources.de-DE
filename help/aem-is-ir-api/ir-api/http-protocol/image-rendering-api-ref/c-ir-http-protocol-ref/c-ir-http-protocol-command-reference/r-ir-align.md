...
Der Renderer wendet die Textur auf das Objekt an, sodass der Textur-Verankerungspunkt ( `anchor=`) mit dem angegebenen Herkunft-Punkt übereinstimmt.

Jedes Objekt kann bis zu 6 Herkünfte (0,1, 3, 4, 5, 6) definieren. Wenn ein `align` Wert angegeben ist, der entsprechende Herkunft-Punkt jedoch nicht vom Vignettenobjekt definiert ist, wird der Standardpunkt (Zentriert-Übereinstimmung) für die Herkunft verwendet.
