...
Die neuesten Versionshinweise, in denen die neuen Funktionen, Verbesserungen und Fehlerbehebungen für Adobe Scene7 Publishing System 6.10 beschrieben werden, die Teil der Adobe Experience Manager-Lösung in Adobe Experience Cloud sind.
...
* **Zu den vordefinierten HTML5-E-Katalog-Viewern wurden neue Einstellungen hinzugefügt** - Im **[!UICONTROL Setup]** > **[!UICONTROL Anwendungseinstellungen]** > **[!UICONTROL Viewer-Vorgaben]** > `Universal_HTML5_eCatalog` oder `Universal_HTML5_eCatalog_Adv` wurden die folgenden Ergänzungen zur jeweiligen [!DNL Configure Viewer] vorgenommen:
...
* **Zu den vordefinierten Viewern für gemischte HTML5-Mediensets wurden neue Einstellungen hinzugefügt** - Im **[!UICONTROL Setup]** > **[!UICONTROL Anwendungseinstellungen]** > **[!UICONTROL Viewer-Vorgaben]** > `Universal_HTML5_MixedMedia_dark` oder `Universal_HTML5_MixedMedia_light` wurden die folgenden Ergänzungen zur jeweiligen [!DNL Configure Viewer] vorgenommen:
...
* Option zur Neusynchronisierung des Katalogservers innerhalb der IPS Classic-Publish Validieren - entfernt.
...
* Die Primäre PSD-Datei wurde mehrmals pro Image-Server als veröffentlicht protokolliert.
...
* Die PDFL-Rasterung von Kunden-PDF führte zu einer unerwarteten weißen Linie im generierten Bild.
...
Viewer-Upgrades sind abwärtskompatibel. Es sind keine Änderungen am vorhandenen Web-Code erforderlich. Es wird jedoch empfohlen, die neuen Viewer in der Staging-Umgebung von Adobe zu testen. Die folgende Website enthält Anweisungen dazu, wie Sie Ihr System für den Zugriff auf den Staging-Server von Adobe einrichten können:
...
* Die CSS-Größenmarkierungen für HTML5-Spin-, BasicZoom-, Zoom-, Spin- und MixedMedia-Viewer in Desktop-Browsern wurden entfernt.
...
* Fehlerhafte `clientAddressFilter` verursachte eine Ausnahme vom Katalogserver bei der Verwendung der Einstellungen für Secure Test Image Serving Publish.
* Das Kopieren der URL für das PDF schlägt im Chrome-Browser fehl, wenn mehrere aufeinander folgende Leerzeichen in der URL vorhanden sind.
...
* Die Option Image Serving Publish-Typ wurde hinzugefügt.
...
* Die Meldung, die auf der Begrüßungsseite für das Scene7 Publishing System angezeigt wird, wurde geändert.
...
* **Hinweis zum Ende der Nutzungsdauer von Flash Viewers** *Mit dem 31. Januar 2017 hat Adobe Scene7 (jetzt Dynamic Media Classic) offiziell den Support für die Flash-Viewer-Plattform beendet.*
