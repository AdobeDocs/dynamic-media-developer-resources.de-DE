...
description: '"Die neuesten Versionshinweise, in denen die neuen Funktionen, Verbesserungen und Fehlerbehebungen für das Adobe Scene7 Publishing System 6.10, Teil der Adobe Experience Manager-Lösung in der Adobe Marketing Cloud, beschrieben werden."'
...
* **Flash Viewers End-of-Life** *NoticeAb dem 31. Januar 2017 stellte Adobe Scene7 (jetzt Dynamic Media Classic) offiziell die Unterstützung für die Flash-Viewer-Plattform ein.*
...
* UGC-Videos werden in dieser Version aufgrund der geringen Akzeptanz nicht mehr unterstützt. Die Einrichtung eines anderen Dynamic Media Classic-Kontos kann als Ersatz für UGC-Videos dienen. Wenden Sie sich an den technischen Support der Adobe, um ein anderes Konto einzurichten.
