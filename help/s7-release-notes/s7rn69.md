---
description: '"Die neuesten Versionshinweise beschreiben die neuesten Funktionen, Verbesserungen und Fehlerbehebungen für Adobe Scene7 Publishing System 6.9, Teil der Adobe Experience Manager-Lösung in der Adobe Marketing Cloud."'
...
* Videountertitel sind jetzt im vordefinierten `Universal_HTML5_MixedMedia_dark`- und `Universal_HTML5_MixedMedia_light`-Viewer verfügbar. Siehe [Hinzufügen von Untertiteln zu Video](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/video/adding-captions-video.html#video).
...
* Secure Testing for Render Server-Anforderungen - Secure Testing für Core-Image Serving-Assets und Video-Assets wurde jetzt um Vignetten erweitert. Siehe [Testen von Assets, bevor sie veröffentlicht werden.](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/upload-publish/testing-assets-making-them-public.html#upload-publish)
* Überwachung der Cache-Funktion &quot;Ungültiges CDN&quot;: Nachdem Sie Ihre Vorlage für das Ungültigmachen von CDN ausgewählt haben (siehe [Allgemeine Einstellungen](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/setup/application-setup.html#general-settings)) und eine **[!UICONTROL Ungültiges CDN]**-Anforderung aus dem Menü &quot;Datei&quot;in SPS erfolgt, wird nun ein Indikator in der Benutzeroberfläche angezeigt, der eine Schätzung der Dauer zum Löschen des Cache enthält.
...
* Korrigiert - IE9: s7sdk.Ereignis: PageMouseEvent: Klicken Sie auf die Browserseite und klicken Sie auf die Dublette und dann auf Ereignisses Triggers.
...
**Neue Funktionen, Verbesserungen und Fehlerkorrekturen für Dynamic Media Image Serving Viewers 5.1.1**
