...
* Die Highlights der Version [Scene7 Publishing System 6.9](s7rn69.md#section-2ed72b7902be4509876d81f25b5632ce)
...
Nachdem Sie Ihren Computer für den Zugriff auf den Staging-Server eingerichtet haben, können Sie Ihre Website überprüfen, um das Upgrade zu testen. Für Kunden, die vordefinierte HTML5-Viewer verwenden, empfiehlt es sich, einen Test mit einem standardmäßigen Adobe-Staging-Server und s7is1-preview-staging.scene7.com durchzuführen.

Neue Funktionen und Verbesserungen

Siehe auch [Scene7 Viewers-Referenzhandbuch](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html?lang=en).
...
* Unterstützung für Inhaltsverzeichnisse wurde zum HTML5-E-Katalog-Viewer hinzugefügt.
* Der E-Katalog HTML5 unterstützt jetzt Imagemap-Überlagerungen statt -Symbolen.
* Der E-Katalog-Viewer HTML5 unterstützt jetzt Seitenumbruch-Animationen.
* Unterstützung für natives Scrollen von Seiten im HTML5-E-Katalog hinzugefügt.
* Es wurde Unterstützung für die Anzeige schmaler Bilder mit `highlightmode` Modifikator zum HTML5 Flyout Viewer hinzugefügt
* Unterstützung zum Steuern der Hochskalierung von Bildern mit `zoomfactor` Modifikator zum HTML5-Flyout-Viewer hinzugefügt.
* Unterstützung für Tracking-Ereignisse hinzugefügt, die vom HTML5-Flyout-Viewer generiert werden.
* Unterstützung für Untertitel für Videos (nur erstes Video) zum HTML5 MixedMedia-Viewer hinzugefügt.
...
* Das Posterbild kann einen Fehler „max size“ aufweisen. Daher müssen Sie die Einstellung für das Limit für Image-Serving-Publish erhöhen.
...
* Für vordefinierte HTML5-Video-Viewer-Vorgaben kann keine Vorschau angezeigt werden.
* Das Scene7-Veröffentlichungssystem erinnerte sich weiterhin an die Gruppe, auch wenn die Regel neu geschrieben wurde.
* Das Scene7-Veröffentlichungssystem hat bestimmten Code für reguläre Ausdrücke für eine Wiederholung nicht richtig angezeigt.
...
* Metadaten-Server und Ähnlichkeitssuche wurden 2015 aufgrund geringer Akzeptanz eingestellt. Wenn das offizielle Zieldatum für die Einstellung bekannt gegeben wird, wurden betroffene Kunden vom technischen Support von Adobe benachrichtigt.
* Erinnerung: Am 31. Januar 2014 hat Scene7 offiziell die Unterstützung für die DHTML-Viewer-Plattform beendet.
