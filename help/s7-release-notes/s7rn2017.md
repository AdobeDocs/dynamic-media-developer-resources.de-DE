...
Die neuesten Versionshinweise für Adobe [!DNL Dynamic Media] Klassischer Teil der [!DNL Adobe Experience Manager] in der [!DNL Adobe Experience Cloud].
...
* HTML5-Video
   ...
   * Für Videobeschriftungen ist ein Regelsatz erforderlich, wenn das Hosting der HTML-Seite von einem externen Server aus erfolgt (nicht von einem [!DNL Dynamic Media] -Server). Wenden Sie sich an den Adobe-Support , um Hilfe zu erhalten.
