...
Die neuesten Versionshinweise zur Adobe [!DNL Dynamic Media] Classic - Teil der Adobe Experience Manager-Lösung in der Adobe Experience Cloud.
...
Die vollständige Dokumentation finden Sie unter [Viewer-Referenzhandbuch](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html).
...
* HTML5-Video
   ...
   * Für Videobeschriftungen ist ein Regelsatz erforderlich, wenn das Hosting der HTML-Seite von einem externen Server aus erfolgt (nicht von einem [!DNL Dynamic Media] -Server). Wenden Sie sich für Unterstützung an den Support der Adobe.
