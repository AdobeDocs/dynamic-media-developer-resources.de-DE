...
seo-description: Die neuesten Versionshinweise für Adobe Dynamic Media Classic, Teil der Adobe Experience Manager-Lösung in der Adobe Experience Cloud.
seo-title: Versionshinweise zu dynamischen Medien
title: Versionshinweise zu dynamischen Medien
...
## Versionshinweise zu dynamischen Medien {#topic-1f5af440670a42f3bbb662eb86a196c6}

Die neuesten Versionshinweise für Adobe Dynamic Media Classic, Teil der [!DNL Adobe Experience Manager] Lösung in der [!DNL Adobe Experience Cloud].
...
Eine vollständige Dokumentation finden Sie im Referenzhandbuch [zu Viewern für](https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/)dynamische Medien.
...
* HTML5-Video
   ...
   * Videountertitel erfordern einen Regelsatz für die Firma, wenn das Hosting der HTML-Seite von einem externen Server (nicht von einem Dynamic Media-Server) bereitgestellt wird. Wenden Sie sich zwecks Hilfe an den Adobe-Support.
