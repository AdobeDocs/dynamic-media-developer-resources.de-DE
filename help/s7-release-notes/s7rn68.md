...
* HTML5 E-Katalog-Viewer-Maus-Drag &amp; Drop funktioniert in Internet Explorer nicht mit Seite, die Imagemaps enthält.
...
* &quot;Leerzeichen nach&quot;funktioniert nicht; sollte `sa`, derzeit ist es `margb`.
...
* Dynamische (Flash-)Banner werden in dieser Version nicht mehr unterstützt. Die Übernahme dieser Funktion war gering, da andere Technologien zur Erstellung, Verwaltung und Bereitstellung personalisierter Website-Banner entwickelt wurden. Die Funktion für dynamische Scene7-Banner (Flash) funktioniert serverseitig weiterhin, wird jedoch nicht mehr unterstützt.
...
* Korrigiert: Container-Koordinaten falsch, wenn der Container mit der CSS-Transformation verschoben wird.
...
* Korrigiert: Symbol für Freigabe in sozialen Netzwerken wird nicht ausgeblendet. `controlbar` auf Zoom.
* Korrigiert: Symbol für Freigabe in sozialen Medien wird beim ersten Einblenden in Galaxy SIII nicht angezeigt.
* Korrigiert: Modale Dialogfelder für Social Sharing werden in iPad3 nicht im Vollbildmodus angezeigt.
* Korrigiert: Modale Dialogfelder für die Freigabe in Social Media werden in Mac mit Safari 5.1 nicht im Vollbildmodus angezeigt.
...
* Korrigiert: Muster im Medienset können nach der Videowiedergabe in iPhone nicht mehr ausgewählt werden.

**ZoomView**

* Korrigiert: Artefakte, die nach dem Zoomen in ein Bild oder dem Drehen des Geräts unter Android™ angezeigt werden.
