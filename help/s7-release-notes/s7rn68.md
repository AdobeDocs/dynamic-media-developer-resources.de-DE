...
* Unterstützung für responsives Webdesign hinzugefügt - Responsive Bildbereitstellung basierend auf Haltepunkten und responsiven HTML5-Viewern (Bildsets, Video, gemischte Medien, eCatalog, Rotationssets, Farbfelder, Zoom), die die Größe basierend auf dem Seitenlayout dynamisch ändern.
...
* HTML5-Viewer verwenden CSS-Eingabe- und Größenmarkierungen zur Steuerung der Anzeige auf Desktop- und Mobilgeräten.

Folgendes wird jetzt unterstützt:

* Integration von Adobe Analytics-Videoberichten für den HTML5-Video-Viewer und den gemischten Medien-Viewer.
* Ereignisverfolgung mehrerer HTML5-Viewer auf derselben Seite.
* Der HTML5 Zoom Viewer und der HTML5 Mixed Media Viewer wurden `SetIndicator` hinzugefügt, um Farbfelder auf Mobilgeräten visuell darzustellen.
...
* Analytics-Handler zu HTML5-Viewern zur Unterstützung des Tracking von Drittanbietern.
...
[More information](http://help.adobe.com/de_DE/scene7/using/WSd4272150f67705c11b002eec12fcba4dee6-8000.html).
-->
...
* Der HTML5-Zoom-Viewer zeigt beim Initiieren oder Zurücksetzen des Zooms ein leichtes Zittern an.
* HTTPS-Unterstützung für HTML5- und AS3-Viewer.
* Die automatische Größenanpassung sollte nicht im HTML Flyout Viewer Copy URL/Embed Code enthalten sein.
* Kein VideoServerUrl-Modifikator in der HTML5-Video-Viewer-Kopier-URL.
* Der `contenturl` ist von der Vorschau-URL des HTML5-Viewers auf dem Veröffentlichungsserver.

**Bildbearbeitung**

* Angepasste Ansicht kann nicht als Standardbild bei der Bildveröffentlichung hinzugefügt werden.
...
* Das Flash-Plug-in und das Scene7 Publishing System sind abgestürzt, da viele Ordner nicht über ausreichend Flash-Speicher verfügen.
...
* Alle Scene7 Publishing System-Web-Admin-Anfragen werden an HTTP umgeleitet.
...
* Sonderzeichen wurden in einer HTML-formatierten E-Mail zum „Kennwort vergessen“ kodiert, wodurch das Kennwort nicht korrekt angezeigt wurde.
* Informationen zum Scene7-FTP-Konto fehlen in der Willkommens-E-Mail für ein Testkonto
...
* Es wird erwartet, dass die Aktualisierung von Adobe Illustrator und Adobe InDesign vom Mai 2014 Inkompatibilitäten mit Plug-ins einführt, die Scene7 FXG erstellen. Diese Inkompatibilitäten wirken sich auf Benutzer der Scene7-Lösung „Web-to-Print“ aus. Wenn Sie Scene7 Web-to-Print verwenden, aktualisieren Sie Illustrator und InDesign nicht auf dieses Creative Cloud-Update. Verwenden Sie stattdessen weiterhin die Version vor Mai 2014. Adobe Inc erwartet, dass die Kompatibilität der Scene7 FXG-Erstellung mit neueren Versionen von Illustrator und InDesign im Herbst 2014 wiederhergestellt wird.
...
* Dynamische (Flash) Banner werden in dieser Version nicht mehr unterstützt. Die Akzeptanz dieser Funktion war gering, da andere Technologien zum Erstellen, Verwalten und Bereitstellen personalisierter Website-Banner entwickelt wurden. Die Funktion „Scene7 Dynamic (Flash) Banner“ funktioniert auf der Serverseite weiterhin, wird jedoch nicht mehr unterstützt.
...
* Abschnitt zum Scene7-FTP-Konto in der Willkommens-E-Mail-Vorlage für Media Portal-Benutzer.
* dc.title aus dem Filterbedienfeld, da dies zum Herunterfahren der IPS-Instanz (Image Publishing System) geführt hat.
* Social-Media-Funktionen werden in HTML5-Viewern im Vollbildmodus angezeigt.
* Die Schaltfläche „Schließen“ wird im Vollbildmodus in HTML5-Viewern angezeigt.
...
* Behoben: Das HTTPS-Protokoll generiert eine Sicherheitswarnung auf IE8 unter Verwendung der Flash-Wiedergabe.
* Behoben: Video wird im Vollbildmodus auf Safari 5 bei Verwendung der Flash-Wiedergabe nicht korrekt skaliert.
...
* Es wurde responsive Unterstützung für HTML5 Viewers-Einbettungs-Code hinzugefügt.
