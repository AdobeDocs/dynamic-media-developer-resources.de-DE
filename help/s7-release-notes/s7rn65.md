---
description: In den aktuellen Versionshinweisen werden die neuesten Funktionen, Verbesserungen und Fehlerbehebungen für das Adobe Scene7 Publishing System 6.5, Teil der Adobe Marketing Cloud, beschrieben.
seo-description: In den aktuellen Versionshinweisen werden die neuesten Funktionen, Verbesserungen und Fehlerbehebungen für das Adobe Scene7 Publishing System 6.5, Teil der Adobe Marketing Cloud, beschrieben.
...
In den aktuellen Versionshinweisen werden die neuesten Funktionen, Verbesserungen und Fehlerbehebungen für das Adobe Scene7 Publishing System 6.5, Teil der Adobe Marketing Cloud, beschrieben.
...
* Unterstützung für das Ziehen und Ablegen von Ordnern hinzugefügt.
   ...
   Sie können einen Ordner auch verschieben, indem Sie **[!UICONTROL Datei]** > Ordner **[!UICONTROL verschieben]** wählen.
...
* Es wurden umfassende **[!UICONTROL Verbesserungen am Einbettungscode]** vorgenommen, um die Bereitstellung von Viewern auf Ihren Webseiten zu vereinfachen. Zu den Verbesserungen gehören:
...
* Dynamische Banner bieten verbesserte HTML5-Unterstützung, einschließlich Kreuzkompilierung mit ActionScript/Javascript
* One-Click-Vorschau von [!DNL Dynamic Banners] ist jetzt in Firefox verfügbar
* **[!UICONTROL Web-to-Print]** ermöglicht jetzt die dynamische Erstellung von Hyperlinks in der PDF-Ausgabe
...
* Die neue Option &quot;Kodierte Videos **** anzeigen&quot;auf der Seite &quot; **[!UICONTROL Allgemeine Einstellungen]** &quot;der **[!UICONTROL Anwendungseinstellungen]** bedeutet, dass Sie jetzt Video-Assets in einem Asset-Typ zusammenfassen können, um die Suche und das Durchsuchen zu optimieren.
...
* Unterstützung für die Videowiedergabe auf [!DNL Blackberry] und [!DNL WinMobile 7] Geräten, einschließlich der Bereitstellung über den **[!UICONTROL universellen Viewer]**.

   [Weitere Informationen](http://help.adobe.com/en_US/scene7/using/WS6E593DEA-7D81-4cd6-84B0-85E8BB274176.html#WS1c46793299cf21d77e926d1613177f0a020-8000.html) zum Kapitel [eVideo](http://help.adobe.com/en_US/scene7/using/WS53492AE1-6029-45d8-BF80-F4B5CF33EB08.html).
...
* Die Funktion **[!UICONTROL Ähnlichkeitssuche]** ist aufgrund mehrerer technischer Probleme nicht mehr in enthalten [!DNL Scene7 Publishing System] . [!DNL Adobe] plant eine alternative Investition in die Bildbearbeitungstechnologie für die künftige Integration in Scene7.

**Adobe Digital Marketing Suite-Integrationen**

* [!DNL Scene7] unterstützt jetzt [!DNL Adobe Test&Target] HTML-Angebot zur Personalisierung. Dynamisches Zusammenführen von Angebot-Elementen für hochrelevante Bannerinhalte basierend auf [!DNL Test&Target] Profil- und Kampagne-Regeln.

* Erweiterte Integration mit einer ordnerbasierten Asset-Repository-Synchronisierung und einer Benutzeroberfläche für einheitliche Inhalte in [!DNL Adobe CQ] Angebots. Sie können auf veröffentlichte dynamische Assets zugreifen, sie durchsuchen und sie direkt in Ihr [!DNL Scene7] Konto in CQ-Seitenvorlagen einfügen.
