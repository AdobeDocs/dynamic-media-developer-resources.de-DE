...
<!--       [More information](http://help.adobe.com/de_DE/scene7/using/WS662101DF-D697-47a7-A7D8-B52FD8E94438.html). -->

**Asset-Management und -Veröffentlichung**

* Verbesserter Workflow für die Asset-Veröffentlichung. <!-- [More information](http://help.adobe.com/de_DE/scene7/using/WS3673AD39-098B-4f08-8A24-CA51261B7366.html). -->
* Verbesserte Benutzerfreundlichkeit der Vorlagenvorschau. Weitere Informationen finden Sie in den folgenden Abschnitten:

<!--
   [Configuring default viewers](http://help.adobe.com/de_DE/scene7/using/WS98ca2e6790647c06-76b2d0e0135685cd4a8-8000.html)

  [Previewing an asset based on viewer platform type](http://help.adobe.com/de_DE/scene7/using/WS98ca2e6790647c06-2ce305113564963202-7fff.html)

  [Previewing an image asset based on its image preset](http://help.adobe.com/de_DE/scene7/using/WS98ca2e6790647c06-2ce305113564963202-7ffe.html)
  -->

* Nach dieser Version wird schrittweise eine neue Funktion zur Instant Publish eingeführt. Diese Funktion ersetzt die aktuelle Funktion „Zur Veröffentlichung markieren“. Einige Benutzer sehen die neue Funktion möglicherweise vor anderen. Die SPS-Dokumentation und Benutzeroberflächenelemente sollen aktualisiert werden, wenn der Rollout-Zeitraum nahezu abgeschlossen ist. Sie können planen, eine E-Mail mit weiteren Details zu Beginn des Rollouts zu erhalten.
...
<!--   [More information](http://help.adobe.com/de_DE/scene7/using/WS98ca2e6790647c06-2ce305113564963202-7fff.html) -->

* Umfassende neue Viewer-Komponenten in der HTML5 SDK. (Weitere Informationen dazu finden Sie in der HTML 5 SDK-Readme-Datei, die im Installationsprogramm enthalten ist.)
* Enhanced Flash SDK. (Weitere Einzelheiten finden Sie in der Readme-Datei zu Flash SDK, die mit dem Installationsprogramm geliefert wird.)
...
* Globalisierungsunterstützung für Viewer einschließlich Lokalisierung von Text und Grafiken wurde hinzugefügt. Sehen Sie sich die im SDK-Installationsprogramm enthaltenen Benutzerhandbücher für den Flash- oder HTML5-Viewer-SDK an.
* E-Katalogen mit eingebetteten Video- und Rotationsansichten wurde Interaktivität hinzugefügt.
* Vereinfachter Zugriff auf die Flash- und HTML5-Viewer-SDKs von Adobe Developer Connection aus. <!-- [More information](http://help.adobe.com/de_DE/scene7/using/WSd4272150f67705c11b002eec12fcba4dee6-8000.html). -->
* Erweiterte universelle Viewer-Profile - Sie können jetzt mehrere Profile pro Viewer-Typ haben. <!-- [More information](http://help.adobe.com/de_DE/scene7/using/WS1c46793299cf21d73076df86131b02b67e8-8000.html). -->
...
* Vorlagensätze : Einfaches Verwalten der Veröffentlichung verschiedener Varianten einer Scene7-Basisvorlage direkt im Scene7 Publishing-System, sodass keine URLs im Seiten-Code geändert werden müssen. <!-- [More information](http://help.adobe.com/de_DE/scene7/using/WSd968ca97bf00cf72-5eede3a113268dc80f5-8000.html).  -->
* Grundlegender Vorlageneditor „Entwicklermodus“: Bearbeiten Sie komplexe Vorlagen-URLs direkt im Scene7 Publishing System und testen Sie die Ergebnisse sofort mit der integrierten Vorschau.
...
* Dynamische Bearbeitung von mit Adobe Illustrator erstellten Warp-Verzerrungen in Scene7 Web, um Online-Workflows zu drucken. <!-- [More information](http://help.adobe.com/de_DE/scene7/using/WSef8d5860223939e2-d19776312a7267a200-8000.html#WSd968ca97bf00cf72-5eedd3a113268dc80f5-8000). -->

**E-Video**

* Verbesserte Leistung und Durchlaufzeit für die Transkodierung von Videos.
* Vereinfachte Desktop-Videovorgaben mit demselben fps wie das Quellvideo. <!-- [More information](http://help.adobe.com/de_DE/scene7/using/WSE86ACF2B-BD50-4c48-A1D7-9CD4405B62D0.html#WS1c46793299cf21d7-39fae9c1131ba8968f7-7fff).  -->
...
* iOS-Streaming für benutzergenerierte Inhalte (UGC) <!-- [More information](http://help.adobe.com/de_DE/scene7/using/WSe8b0455615e2dc47-2df907a712f31201b35-8000.html). -->
...
* Metadatenansicht, um nur Felder mit Werten anzuzeigen
  ...
  Es gibt eine neue vordefinierte Metadatenansicht namens „Alle Eigenschaften mit Werten“, die nur Metaeigenschaften anzeigt, die Werte enthalten. Eigenschaften (aus XMP, benutzerdefinierte Felder oder die neuen Metadatenschemata) ohne Werte sind ausgeblendet und werden nicht angezeigt.
