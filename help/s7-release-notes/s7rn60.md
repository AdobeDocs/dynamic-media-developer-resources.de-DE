...
* &quot;Code einbetten&quot;wurde hinzugefügt, um die Bereitstellung von Viewern zu vereinfachen.
   ...
   Verwenden der [!DNL Embed Code] -Funktion können Sie den Viewer-Code auf den ausgewählten Asset-Typ überprüfen. Sie können den Code auch in die Zwischenablage kopieren, damit Sie ihn in Webseiten für die Bereitstellung des Viewers einfügen können. Die Bearbeitung des Codes ist im Dialogfeld Einbettungscode nicht zulässig. .

   Die [!DNL Embed Code] Funktion verfügbar, wenn Sie die [!DNL Preview: Viewer List] oder [!DNL URLs] Bedienfeld in [!DNL Detail View] für einen der folgenden Asset-Typen:
...
* Dynamische Erstellung animierter GIF-Flashs mit Quellinhalten für dynamische Banner (FLA), einschließlich erweiterter Bildverwaltung. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd968ca97bf00cf72-5eedd3a113268dc80f4-8000.html).  -->
...
* Metadateneinstellungen werden jetzt in der Verwaltungsbenutzeroberfläche gruppiert.
   ...
   In **[!UICONTROL Einrichtung > Anwendungseinstellungen]**, werden die metadatenbezogenen Einstellungsseiten jetzt in einem Abschnitt der obersten Ebene namens [!DNL Metadata]. Hier finden Sie die Einstellungsseiten für Metadatenansicht, Metadatenvorgaben, Metadatenschema und die benutzerdefinierten Felder.
