...
* Umfassende neue Viewer-Komponenten im HTML5-SDK. (Weitere Informationen finden Sie in der im Installationsprogramm enthaltenen HTML 5-SDK-Bitte-Bitte.)
...
* Die neuen HTML5-Viewer beinhalten Folgendes:

   * Zoom
   * Bildsatz
   * Musterset

* Zusätzliche Globalisierungsunterstützung für Viewer, einschließlich der Lokalisierung von Text und Grafiken. Weitere Informationen finden Sie in den Benutzerhandbüchern zum Flash- oder HTML5-Viewer-SDK, die im SDK-Installationsprogramm enthalten sind.
...
* Integration mit Adobe CQ5: Asset-Synchronisation, in CQ5 eingebettete Scene7-Viewer und dynamische Bereitstellung von Rich-Media-Inhalten auf CQ5-Seiten über das Scene7-Netzwerk.
* Neuer integrierter Workflow mit Adobe Search&amp;Promote: Fügen Sie einfach Scene7-Marketing-Banner hinzu, die basierend auf Search&amp;Promote-Kampagnenregeln dynamisch zusammengestellt werden, um Seiten zu suchen und zu navigieren.

   Siehe &quot;Info zu Bannern&quot;in der Dokumentation zur Search&amp;Promote von Adoben.

* Scene7/Creative Suite - kompatibel mit der bevorstehenden Version von Adobe Creative Suite 6.
...
* Dynamische Erstellung animierter GIF-Flash-Quellinhalte (FLA) für dynamische Banner, einschließlich erweiterter Bildverwaltung. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd968ca97bf00cf72-5eedd3a113268dc80f4-8000.html).  -->
...
* Metadateneinstellungen werden jetzt in der Verwaltungsbenutzeroberfläche gruppiert.
   ...
   Unter **[!UICONTROL Einrichtung > Anwendungseinstellungen]** sind die Seiten mit metadatenbezogenen Einstellungen jetzt in einem übergeordneten Abschnitt namens [!DNL Metadata] gruppiert. Hier finden Sie die Einstellungsseiten für Metadatenansicht, Metadatenvorgaben, Metadatenschema und die benutzerdefinierten Felder.
...
* Es wurde ein Problem behoben, das dazu führte, dass Uploads sehr großer EPS-Dateien fehlschlugen.
